    ...
    <header>
        <div class="container-fluid nav-top-box">
            <nav>
                ...
                <div class="logo">
                    <a href="index.php"><img class="main-logo" src="images/main-logo.png" alt="logo principal du site"><h1 class="main-title">Les<span class="color-wild">4</span>FantasGit</h1></a>
                </div>
                <div class="menu">
                    <ul>
